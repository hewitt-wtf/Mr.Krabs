    ...
    execute: ({ bot, message, send }) => {
        ...
        embeds.push(new CustomEmbed()
            ...
            .addFields(
                ...
                {
                    name: "Hand:",
                    value: "Each player has a hand, size of which is determined by the game. The hand is what will ultimately decide who wins the game. The hand is created from the Standard deck of cards"
                }
            )
        );
        embeds.push(new CustomEmbed()
            ...
            .addFields(
                {
                    name: "Round Start:",
                    value: "When A round starts, the dealer can make choices to modify the game rules. For basic poker, the dealer can choose 0-2 rounds of 1-2 card trades. These allow players to increase the Value of their hands."
                },
                {
                    name: "Entering the Round:",
                ...
                {
                    name: "Trading cards:",
                    value: "After choosing to play or not, if the dealer has specified, players can trade one or two cards from their hands with new ones from the deck. One should get to know the combinations worth the most points, and decide which cards to trade on behalf of that."
                },
                {
                    name: "Game End:",
                    value: "The game ends when Only one player has chips left, and all other players are out."
                },
                {
                    name: "All in",
                    value: "When you are unable to add as many chips as you want, and spend the rest of your chips, you are all in. You can no longer raise or call, and the pot is sepperated. Other players can now still bet in a sepperate pot, and you can only win your current balance from all players. If you run out of chips, you are out"
                },
                {
                    name: "Winning a round",
                    value: "At the end of a round, The player who are still in compare their hands, and the winner is decided due to the combo chart. In case of a tie the pot is split between those tied, no suit takes precidence."
                }
            )
        );
        embeds.push(new CustomEmbed()
            ...
            .addFields(
                {
                    name: "Global Economy",
                    value: "The Global economy can be impacted by Poker games, depending on the choice to make a game friendly or not"
                },
                {
                    name: "Friendly v.s. Competitive",
                    value: "Friendly games can be played with any chip amount, and do not impact the global economy. Competitive games require you to have the amount of chips given to enter, and you gain or lose in the global standings depending on how you play"
                }
            )
        );
